...
public class CircularProgressBar extends View {
    ...
    public CircularProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CircularProgressBar, defStyleAttr, 0);
        mBorderWidth = a.getDimension(R.styleable.CircularProgressBar_borderWidth,
                DEFAULT_BORDER_WIDTH * density);
        a.recycle();
        mColors = new int[4];
        mColors[0] = context.getResources().getColor(R.color.gray);
        mColors[1] = context.getResources().getColor(R.color.gray);
        mColors[2] = context.getResources().getColor(R.color.gray);
        mColors[3] = context.getResources().getColor(R.color.gray);
    ...
    private Property<CircularProgressBar, Float> mAngleProperty = new Property<CircularProgressBar, Float>(Float.class, "angle") {
        @Override
    ...
    private Property<CircularProgressBar, Float> mSweepProperty = new Property<CircularProgressBar, Float>(Float.class, "arc") {
        @Override
        public Float get(CircularProgressBar object) {
